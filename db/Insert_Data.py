...
def Insert_cmpr_Dtl(cur: pymysql.cursors.Cursor, _cmprDtl: cmpr_Dtl, conn: pymysql.Connection):
    ...
    try:
        cur.execute(query, (
            _cmprDtl.cmpr_Dtl_Code, _cmprDtl.cmpr_Dtl_Nm,_cmprDtl.cmpr_Dtl_Engl_Nm,
                    _cmprDtl.sfe, _cmprDtl.prsiundo, _cmprDtl.in_Value, _cmprDtl.mouthresdng,
                    _cmprDtl.ctmouthresdng, _cmprDtl.f_Value, _cmprDtl.p_Value,
                    cmpr_item_code, cmpr_measure_year, cmpr_achl_kind_code
        ))
        conn.commit()
        return cur.rowcount
    except pymysql.MySQLError as e:
